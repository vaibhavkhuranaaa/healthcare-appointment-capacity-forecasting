/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/env.d.ts` (hash: 07d2850e6242cf9aba22dc6dc16dc576)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	DATA: R2Bucket;
	RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	RELEASE_POINTER: "candidate.json" | "current.json";
	SOURCE_SHA: "unpublished";
}
declare namespace Cloudflare {
	...
	interface CandidateEnv {
		...
		RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		RELEASE_POINTER: "candidate.json";
		SOURCE_SHA: "unpublished";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELEASE_POINTER" | "SOURCE_SHA">> {}
}
