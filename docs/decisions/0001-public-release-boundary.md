...
The revamp needs phase gates, dataset approvals, evaluation thresholds, cost records, and a maintainer handoff without publishing private operating context or source data. The split also gives the public repository one enforceable release boundary.
